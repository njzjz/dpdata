...
def dump(folder, data):
    ...
    nframes = data['cells'].shape[0]
    np.savetxt(os.path.join(folder, 'type.raw'),
               data['atom_types'], fmt='%d')
