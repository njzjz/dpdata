...
class TestMultiDeepmdDumpRaw(unittest.TestCase, CompLabeledSys):
    def setUp(self):
        ...
        self.system_1 = dpdata.LabeledSystem(os.path.join(
            path, 'C1H3'), fmt='deepmd/raw', type_map=['C', 'H'])
        self.system_2 = system_3
...
class TestMultiDeepmdDumpComp(unittest.TestCase, CompLabeledSys):
    def setUp(self):
        ...
        self.system_1 = dpdata.LabeledSystem(os.path.join(
            path, 'C1H3'), fmt='deepmd/npy', type_map=['C', 'H'])
        self.system_2 = system_3
    ...
    def test_type_map(self):
        for type_map in permutations(['C', 'H', 'O', 'N'], 4):
            systems = dpdata.MultiSystems(
                self.system_1, self.system_2, self.system_3, self.system_4, type_map=type_map)
